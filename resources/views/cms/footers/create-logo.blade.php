        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Footer Logo Create</li>
                            </ol>
                        </nav>
                    </div>
                    @if (session('error'))
                    ...
                    <form id="footerForm" class="footerForm" method="POST" action={{ route('cms.footers.logo.store') }}
                        data-section="logo" enctype="multipart/form-data">
                        <input type="hidden" name="contentInput" class="contentInput" value="">
                        <input type="hidden" name="key_id" value="2">
                        @csrf
                            ...
                            <div class="card-body">
                                <div id="dynamicFields" class="mt-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2" id="logo-preview-wrapper" style="display:none;">
                                                <img id="logo-preview" src=""
                                                    style="max-width:200px; border-radius:4px;" alt="Logo Preview">
                                            </div>
                                            <input type="file" class="form-control dynamic-field logo-input"
                                                id="image" name="logo" data-field="logo" data-index="0"
