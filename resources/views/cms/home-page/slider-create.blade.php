                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form enctype="multipart/form-data" method="POST" action="{{ route('cms.home-page.slider.store') }}" class="forms-sample form-confirm-submit" id="myForm">
                                        @csrf
                                        <div class="form-group">
                                            <label for="title">Title<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter main headline" value="{{ old('title') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Enter a short description or slogan" value="{{ old('subtitle') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="image">Slider Image (<2MB)<span class="text-danger">*</span></label>
                                            {{-- Preview image --}}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="button_text" name="button_text" placeholder="Enter a short text of button" value="{{ old('button_text') }}">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="button_link" name="button_link" placeholder="Enter a link of button" value="{{ old('button_link') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="regular_price" name="regular_price" placeholder="Regular Price" value="{{ old('regular_price') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="sale_price" name="sale_price" placeholder="Sale Price" value="{{ old('sale_price') }}">
                                              ...
                                              <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="date_end" name="date_end" placeholder="Date End" value="{{  old('date_end')}}">
                                        ...
                                        <button type="submit" class="btn btn-gradient-primary me-2" id="submitBtn" disabled>Submit</button>
