                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.events.store') }}" class="forms-sample form-confirm-submit" id="myForm">
                                        @csrf
                                        <div class="form-group">
                                            <label for="title">Event Title<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter event title here" value="{{ old('title') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" name="start_time" id="start_time" class="form-control" value="{{ old('start_time', isset($event) ? $event->start_time : '') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" name="finish_time" id="finish_time" class="form-control" value="{{ old('finish_time', isset($event) ? $event->finish_time : '') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="address" name="address" placeholder="Enter event address here" value="{{ old('address') }}">
                                            ...
                                            <div id="content-wrapper">
                                                <div class="content-item-wrapper mb-2" id="wrapper-0">
                                                    <div class="content-item mb-2">
                                                        <input type="text" class="form-control content-line" id="content_item" placeholder="Enter event content here">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" class="form-control" id="cost" name="cost" min="0" max="999999.99" placeholder="Enter cost of event ticket here ($)" value="{{ old('cost') }}">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="total_slots" name="total_slots" min="0" max="1000" placeholder="Enter total slots of event here" value="{{ old('total_slots') }}">
