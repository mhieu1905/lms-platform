            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb p-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.users.students.index') }}">Student List</a>
                                </li>
                    ...
                    <div class="row">
                                ...
                                <div class="scroll-table">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            @else
                                            <td><img src="{{ asset('storage/' . $student->avatar) }}" alt="Student avatar"></td>
                                            @endif
                                        ...
                                        <tr>
                                            <th>Actions</th>
                                            <td>
                                                <form action="{{ route('admin.users.students.destroy', $student->id) }}" method="POST" style="display:inline;" class="delete-form form-confirm-submit">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        @if($student->enrolled_courses_count > 0)
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card">
                                    <div class="card-body">
                                        <h5>List of courses enrolled</h5><br>
                                        <div class="scroll-table">
                                        <table class="table table-bordered">
                                            <tr>
                                                <th>Course Title</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($course->pivot->enrolled_at)->format('d/m/Y - H:i') }}</td>
                                            </tr>
                                            @endforeach
                                        </table>
                                        </div>
