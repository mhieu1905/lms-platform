                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('admin.majors.store') }}" class="forms-sample form-confirm-submit" id="myForm">
                                        @csrf
                                        <div class="form-group">
                                            <label for="name">Major Name<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Major Name" value="{{ old('name') }}">
